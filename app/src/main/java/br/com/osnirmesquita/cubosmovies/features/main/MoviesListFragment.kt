...
class MoviesListFragment : Fragment() {
    ...
    private var moviesList = mutableListOf<MovieUI>()
    ...
    private fun fetchMovies() {
        CompositeDisposable().add(
            api.getMovies(count)
                ...
                .subscribe({
                    val result = it.result.map { movie -> MovieUI(movie.id, movie.title, movie.pathImage) }
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): MoviesListFragment {
